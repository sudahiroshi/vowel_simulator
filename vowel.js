...
window.addEventListener("load", () => {
  //document.querySelector('#base').addEventListener('mousemove',()=>{return false;},true);
  //document.querySelector('#base').addEventListener('mousedown',()=>{return false;},true);
  //document.querySelector('#base').addEventListener('mouseup',()=>{return false;},true);
  //document.querySelector('#base').addEventListener('click',()=>{return false;},true);
  var vowel = null;
